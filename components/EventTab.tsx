             ...
             <div className="bg-[#111827] border border-slate-800 rounded-[2.5rem] p-8 mb-8 shadow-xl">
                ...
                <div className="mt-6 pt-6 border-t border-slate-800">
                   <div className="relative">
                      <input type="text" placeholder="輸入關鍵字進行全文搜尋..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full bg-[#111827] border border-slate-700 rounded-xl py-3 pl-12 pr-4 text-sm text-slate-200 outline-none focus:border-blue-500 transition-all shadow-inner" />
